...
#Date: 08/01/2018
#Sanjeev Sariya
##Model 2 - Adjust for age, sex, MDS, kinship, APOE 
...
model0_all <- glmmkin(AD ~ age + sex +mds1 +mds2 + mds3 + APOE, data = pheno_all, kins = grm_all, family = binomial(link = "logit"))
