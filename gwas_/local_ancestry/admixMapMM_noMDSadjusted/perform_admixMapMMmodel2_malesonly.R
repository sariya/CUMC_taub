...
#Date 04/30/2019
#Sanjeev Sariya
#Local Ancestry APOE E4 adjusted Males only no mds adjustment
...
file.pheno<-"/mnt/mfs/hgrcgrid/shared/GT_ADMIX/CHGWAS_analyses_data/multi_merged_data/merge_MESA_NOMAS_HGWAS126/local_ancestry_analysis/localancestry_analysis/RFMIX_datapreparations/genesis_admixMapMM/input.phenoapoeE4.malesonly"
