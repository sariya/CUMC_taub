...
#Date 04/30/2019
#Sanjeev Sariya
#Local Ancestry APOE E4 adjusted FeMales only no MDS adjustment
...
file.pheno<-"/mnt/mfs/hgrcgrid/shared/GT_ADMIX/CHGWAS_analyses_data/multi_merged_data/merge_MESA_NOMAS_HGWAS126/local_ancestry_analysis/localancestry_analysis/RFMIX_datapreparations/genesis_admixMapMM/input.phenoapoeE4.femalesonly"
...
covariates <- c( "age" ,"apoe") ##make sure sex is M/F. 0/1 isn't acccepted
outcome <- "AD"
