...
CairoJPEG(filename = "boxplot_HRC1000G.jpeg",quality = 75,width = 1500, height = 900)
ggplot(binned_snps,aes(x=binned,y=info,fill=panel)) + scale_y_continuous(breaks=seq(0.0, 1, 0.1)) +
...
CairoJPEG(filename = "boxplot_HRC1000G_uncommon.jpeg",quality = 75,width = 1500, height = 900)
theme_set(theme_grey(base_size = 18))
ggplot(binned_snps,aes(x=binned,y=info,fill=panel)) +  scale_y_continuous(breaks=seq(0.0, 1, 0.1)) +
geom_boxplot( alpha=0.2,notch=FALSE,width=0.5) + scale_fill_manual(values=c("blue","green")) +
...
CairoJPEG(filename = "boxplot_HRC1000G_ultrarare.jpeg",quality = 75,width = 1500, height = 900)
theme_set(theme_grey(base_size = 18))
ggplot(binned_snps,aes(x=binned,y=info,fill=panel)) +  scale_y_continuous(breaks=seq(0.0, 1, 0.1)) +
geom_boxplot( alpha=0.2,notch=FALSE,width=0.5) + scale_fill_manual(values=c("blue","green")) +
